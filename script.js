function showPage(page) {
    ...
    if (page === 'home') {
        ...
        content.innerHTML = '<h1>Wiki</h1><p>HypnOS System Requirements:</p><p>2 GB RAM (Recommended 4 GB RAM)</p><p>20 GB Disk Space</p><p>20 GB selam Space</p><p>1 GHz Processor</p>'; 
    } else if (page === 'latest') {
        content.innerHTML = `
